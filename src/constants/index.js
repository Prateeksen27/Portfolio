export const navLinks = [
  ...
  export const calculateSizes = (isSmall, isMobile, isTablet) => {
    return {
      ...
      deskPosition: isMobile ? [0.5, -4.5, 0] : [0.25, -6.1, 0],
      cubePosition: isSmall ? [4, -5, 0] : isMobile ? [5, -5, 0] : isTablet ? [9, -5, 0] : [9, -5.5, 0],
      reactLogoPosition: isSmall ? [2, 7.9, 0] : isMobile ? [4, 6.5, 0] : isTablet ? [8, 6, 0] : [12, 6, 0],
